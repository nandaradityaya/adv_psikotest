...
function getViewerConfiguration() {
  return {
    ...
    toolbar: {
      ...
      openFile: document.getElementById('xASDasd'),
      print: document.getElementById('xASDasd'),
      presentationModeButton: document.getElementById('presentationMode'),
      download: document.getElementById('xASDasd'),
    ...
    secondaryToolbar: {
      ...
      openFileButton: document.getElementById('xASDasd'),
      printButton: document.getElementById('xASDasd'),
      downloadButton: document.getElementById('xASDasd'),
