<%@ WebHandler Language="VB" Class="MASTER_NilaiHasilUjianGridHandler" %>

Imports System
Imports System.Web
Imports Ext.Net

Public Class MASTER_NilaiHasilUjianGridHandler : Implements IHttpHandler, System.Web.SessionState.IReadOnlySessionState
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        oGridHelper.TableName = " ADVPSIKOTEST.dbo.VW_MASTER_TR_PsikotestResult "

        Dim filter = context.Request("Filter")
        If Not filter Is Nothing Then
            oGridHelper.WhereClause = filter
        End If
