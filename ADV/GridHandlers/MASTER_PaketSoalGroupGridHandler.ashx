<%@ WebHandler Language="VB" Class="MASTER_PaketSoalGroupGridHandler" %>

Imports System
Imports System.Web
Imports Ext.Net

Public Class MASTER_PaketSoalGroupGridHandler : Implements IHttpHandler, System.Web.SessionState.IReadOnlySessionState
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        oGridHelper.TableName = " ADVPSIKOTEST.dbo.VW_MASTER_PaketSoalGroup "

        Dim filter = context.Request("PaketSoalGroupFilter")
