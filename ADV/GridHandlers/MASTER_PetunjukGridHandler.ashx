<%@ WebHandler Language="VB" Class="MASTER_PetunjukGridHandler" %>

Imports System
Imports System.Web
Imports Ext.Net

Public Class MASTER_PetunjukGridHandler : Implements IHttpHandler, System.Web.SessionState.IReadOnlySessionState
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        oGridHelper.TableName = " ADVPSIKOTEST.dbo.VW_MASTER_Petunjuk "

        Dim filter = context.Request("Filter")
        If Not filter Is Nothing Then
            oGridHelper.WhereClause = IIf(filter.Equals(""), "", filter)
        End If
